...
urlpatterns = [
    ...
    path('password_change/done/', authViews.PasswordChangeDoneView.as_view(template_name='password_reset/password_change_done.html'), name='password_change_done'),
    path('password_change/', authViews.PasswordChangeView.as_view(template_name='password_reset/password_change.html'), name='password_change'),
    path('password_reset/done/', authViews.PasswordResetCompleteView.as_view(template_name='password_reset/password_reset_done.html'),name='password_reset_done'),
    ...
    path('reset/done/', authViews.PasswordResetCompleteView.as_view(template_name='password_reset/password_reset_complete.html'),name='password_reset_complete'),
    #pdf 
    path('petPdf', views.petPdf,name='petPdf'),
    path('userPdf', views.userPdf,name='userPdf'),
    path('adoptionPdf', views.adoptionPdf,name='adoptionPdf'),
    path('acctionsHistoryPdf', views.acctionsHistoryPdf,name='acctionsHistoryPdf'),
    #historial de acciones 
    path('acctionsHistoryPets', views.acctionsHistoryPets,name='acctionsHistoryPets'),
    path('acctionsHistoryAdoptions', views.acctionsHistoryAdoptions,name='acctionsHistoryAdoptions'),
