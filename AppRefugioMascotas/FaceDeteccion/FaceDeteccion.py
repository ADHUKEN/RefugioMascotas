...
def CAPTURANDO(name):
    ...
    personName = name
    dataPath = 'AppRefugioMascotas/FaceDeteccion/data/' #rutas 
...
def ENTRENANDO(name):
    dataPath = 'AppRefugioMascotas/FaceDeteccion/data/' + name
...
def RECONOCIENDO():
    dataPath = 'AppRefugioMascotas/FaceDeteccion/data/' 
